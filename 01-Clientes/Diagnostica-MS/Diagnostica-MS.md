...
- fatos relatados ou documentados;
- hipóteses confirmadas ou rejeitadas;
- limites da evidência;
- decisões e próximos passos;
- candidatos a aprendizado metodológico reutilizável.

Um aprendizado do caso não deve virar aprendizado geral da Simplifique automaticamente. Quando houver evidência suficiente e possibilidade de reutilização, criar um candidato em `08-Aprendizados/Rascunhos` e referenciar este prospect como origem.
...
Nenhuma métrica interna disponível.
