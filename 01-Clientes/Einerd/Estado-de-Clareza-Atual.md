...
2. P1 — Viabilizar o teste do novo low-ticket com três preços.
3. P2 — Preparar a remessa do YouTube Dark para gravação.
4. P2 — Preservar o fluxo das pendências de Audiovisual e o avanço da Ella, sem novo prazo confirmado.

## 4. Frentes ativas
- Operação de anúncios no Meta: bloqueada para criação e duplicação de campanhas; teste via MCT previsto.
...
- Arthur: criar o Discord para o grupo.
- Pablo: gestor da operação de Audiovisual, conforme estado anterior; nenhuma nova responsabilidade foi confirmada nesta reunião.
- Marcel: sócio do projeto, conforme estado anterior.
- Carla: gestora da operação, conforme estado anterior; falas sobre subir demandas não foram promovidas por falta de compromisso inequívoco no trecho disponível.
- Daniel: Head de Gestão, conforme estado anterior.

## 6. Decisões vigentes
- Testar três preços para o novo low-ticket: R$ 17, R$ 27 e R$ 37.
- Dividir o material do curso em inglês e acompanhar a cadência, conforme estado anterior; vigência não foi contradita.
- Acompanhar Felipe, freelancer responsável pela VSL, conforme estado anterior; vigência não foi contradita.

## 7. Gargalos
- A renovação de campanhas e criativos depende de recuperar a capacidade de criação e duplicação no Meta ou validar a rota via MCT.
- Gravações e remessas pendentes permanecem como gargalo histórico; a reunião não trouxe inventário atualizado.
...
- Os números de investimento, faturamento e ROAS aparecem apenas no resumo automático e não foram promovidos ao EDC sem o trecho correspondente da transcrição.
- Quantidade de demandas abertas, entregas previstas e critérios do teste da Ella continuam não informados.

## 10. O que está pausado
- Dark Creator: preservado como pausado do estado anterior; não houve retomada confirmada.
- VICE deixa de ser tratado como inequivocamente pausado: o resumo o associa ao novo low-ticket em teste, mas a confirmação do nome exige validação devido à compactação.

## 11. O que já não vale mais
- Tratar o VICE como seguramente pausado: há evidência de retomada no resumo e de teste de um low-ticket na transcrição, porém a associação entre ambos ainda precisa de validação.
