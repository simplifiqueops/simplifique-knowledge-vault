...
> [!simp] Agora
> **P1:** definir a situação de Ellen, reduzir custos e concluir as vendas da Cúpula. **5 demandas** e **7 decisões pendentes** no EDC.
...
## EDC simplificado
![[01-Clientes/Realizando-Potenciais/Estado-de-Clareza-Atual#1. Objetivo atual]]
![[01-Clientes/Realizando-Potenciais/Estado-de-Clareza-Atual#3. Prioridades]]
![[01-Clientes/Realizando-Potenciais/Estado-de-Clareza-Atual#4. Frentes ativas]]
...
## Decisões pendentes — 7
![[01-Clientes/Realizando-Potenciais/Estado-de-Clareza-Atual#13. Próxima decisão]]

## Preparação para DEP
- Sinal atual: Pessoas / Capacidade, Financeiro e Vendas.
- Lacuna principal: continuidade de Ellen, caixa para tráfego e fluxo de social media dependem de definição.
